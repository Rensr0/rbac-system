...
| # | 任务 | 优先级 | 说明 |
|---|------|--------|------|
| 133 | 登录页 form 标签警告 | P3 | 浏览器控制台警告"Password field is not contained in a form"，但功能正常 |
| 134 | favicon.ico 404 | P3 | 控制台有 404 错误，但已有 favicon.svg |
| 135 | Redis 缓存 | P2 | 用户列表/角色列表缓存 |
| 136 | API 限流 | P1 | 登录接口频率限制 |
| 137 | CSRF Token | P1 | API 请求 CSRF 验证 |
| 138 | 下拉刷新 | P2 | 移动端列表下拉刷新 |
| 139 | 骨架屏 | P2 | 数据加载时骨架屏占位 |
