...
var ModalTemplates = (function () {
  ...
  var html =
    ...
    + '<div class="form-group" id="form-user-status-group" class="hidden"><label class="form-label">状态</label><select class="form-input" id="form-user-status"><option value="1">正常</option><option value="0">禁用</option></select></div>'
